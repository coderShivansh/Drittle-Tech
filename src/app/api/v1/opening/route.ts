...
export async function POST(req: Request) {
  try {
    ...
    const validatedData: CreateOpeningDto = createOpeningSchema.parse(body);
...
export async function PUT(req: Request) {
  try {
    ...
    const validatedData: UpdateOpeningDto = updateOpeningSchema.parse(body);
